This simple program opens a new empty Chrome tab and navigates to the Daraz pk website where it enters the user's search query and applies the price filter.<br>
